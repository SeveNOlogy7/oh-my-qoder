...
- "This plan is saved to `.omq/plans/auth-system.md`"
...
──────────
1. Review this plan
2. Modify if needed: edit .omq/plans/auth-system.md
...
A: Absolutely! Plans are saved as markdown in `.omq/plans/`. Edit the file, then execute it.
