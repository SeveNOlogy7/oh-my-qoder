...
> Deprecated compatibility alias: use `/oh-my-qoder:skillify` for new skill extraction workflows. This file remains for internal implementation/history and compatibility.
...
- **User-level**: `$QODER_CONFIG_DIR/skills/omq-learned/<skill-name>.md` - Rare. Only for truly portable insights.
...
- /oh-my-qoder:note - Save quick notes that survive compaction (less formal than skills)
- /oh-my-qoder:ralph - Start a development loop with learning capture
