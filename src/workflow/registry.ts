...
const SKILL_ENTRIES: readonly WorkflowEntry[] = [
  ...
  entry({ name: 'ultragoal', kind: 'skill', decision: 'keep', riskClass: 'advisory', owner: REGISTRY_OWNER, notes: 'Retained as the durable multi-goal workflow with its own .omq/ultragoal artifacts (owner direction, 5.0.0).' }),
